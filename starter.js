...
const calculator = (num1, num2, callback) => {
    // wel'll check to see if its true that num1 and num2 can be coerced into numbers
    //if they are able to be nums, we'll do it, and call the callback to do our math
    // if the arent we warn them that they need to be numbers
...
// applyDiscount(dogProducts, 1, applyPercentDiscount, .6)
// console.log(dogProducts)

// applyDiscount(catProducts, 2, applyFlatRateDiscount, .5)
// console.log(catProducts)
...
let myNewerArray = copyArrToSnakeCase(lotr)
// console.log(myNewerArray)

const newCamelCasewArr = lotr.map((element) => {
...
const productOfArrayCallback = (accumlator, currentValue) => {
